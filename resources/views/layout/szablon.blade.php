...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>K28 - @yield('tytul', 'WSB')</title>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8 w-100">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 gap-6 lg:gap-8">
                        <div href="" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex  transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div class="w-100">
